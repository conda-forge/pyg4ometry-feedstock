...
pixi global install pyg4ometry
```
...
It is possible to list all of the versions of `pyg4ometry` available on your platform:
...
```
pixi search pyg4ometry --channel conda-forge
```
